<template>
  <div>
    <div class="bg-card-gachapon">
      <div class="one-element">
        <img
          v-if="type == 1"
          src="../assets/gachapon/bg-gachapon-exc.webp"
          alt="Image"
        />
        <img v-else src="../assets/gachapon/bg-gachapon-std.webp" alt="Image" />
        <div class="overlay">
          <span class="description flex gap-5">
            ...
            <div :class="{ 'text-custom-green': onProgress > 1 }">
          ...
          <span class="description flex gap-5">
            ...
            <div :class="{ 'text-custom-green': onProgress > 2 }">
          ...
          <span class="description flex gap-5">
            ...
            <div :class="{ 'text-custom-green': onProgress > 3 }">
              Generating random numbers with Chainlink
            </div>
          </span>
          ...
          <span class="description flex gap-5">
            ...
            <div :class="{ 'text-custom-green': onProgress > 4 }">
