  ...
  <div>
    <div class="nav-container">
      <div>
        ...
        <nav
          id="menu1"
          class="bar bar-2 hidden-xs hidden-sm hidden-md hidden-lg bar--absolute bg--dark"
        >
          <div class="container">
            <div class="row">
              ...
              <div class="col-xs-12 col-sm-12 col-lg-12 order-lg-2 m-mt-50px">
                <div class="bar__module mb-0 text-center">
                  <ul class="menu-horizontal text-center menu1">
                    <li class="dropdown">
                      <a class="header-menu" href="https://ecio-space.gitbook.io/ecio-white-paper/">
                        WHITEPAPER
                      </a>
                    </li>
                    <li class="dropdown">
                      <a class="header-menu" href="/claim-token"> CLAIM PRESALE </a>
                    </li>
                    <li class="dropdown">
              ...
              <div
                class="col-xs-12 col-sm-12 text-right text-left-xs text-left-sm order-lg-3"
              >
                <ul class="menu-horizontal center-menu">
                  ...
                  <li class="dropdown">
                    <a v-if="!walletAccount" href="#" @click="connectWallet">
                      Connect wallet
                    </a>
                    <a v-if="walletAccount" href="#" @click="connectWallet">
                      {{ shortAddress }}
        ...
        >
          <div class="container">
            ...
            <div style="width: 107%; margin-left: -3%">
            ...
            <div class="row" style="margin-top: -4.3%">
              ...
              <div class="col-xs-12 col-sm-12 col-lg-8 col-xl-11 order-lg-2">
                <div class="bar__module ml-3 mt-1">
                  <ul class="menu-horizontal text-center">
                    ...
                    <li class="dropdown">
                      <a class="header-menu" href="/my-mystery-boxs" >My Mystery Box</a>
                    </li>

                  <li class="dropdown justify-center">
                    <div
                      class="background-image-holder"
                      style="margin-left: -14%; margin-top: -4%; z-index: 0; height : 35px; width : 118px;"
                    >
                      <img
                        alt="background"
                    ...
                    <a
                      ...
                      class="mr-3"
                      style="z-index: 1; color: #ff00b1; font-size : 16px; position : relative;"
                    >
                      PLAY DEMO
                    </a>
                  </li>
                  ...
                  <li class="dropdown justify-center">
                    <div
                      class="background-image-holder"
                      style="margin-left: -38%; margin-top: -4%; z-index: 0; height : 35px; width : 185px;"
                    >
                      <img
                        alt="background"
                    ...
                    <a v-if="!walletAccount" href="#" @click="connectWallet" style="color : #C6FC0E; z-index: 1; position : relative; right : 10px;">
                      Connect wallet
                    </a>
                    <a v-if="walletAccount" href="#" @click="connectWallet" style="color : #C6FC0E; z-index: 1; position : relative; font-size : 16px;">
                      {{ shortAddress }}
                    </a>
                  </li>
              ...
              <!-- <div
                class="col-xs-12 col-sm-12 col-lg-6 text-right text-left-xs text-left-sm order-lg-3"
              >
