      ...
      <div class="row">
        <div class="col-md-6">
          <div class="boxed boxed--border">
            <h1 style="font-size: 1.2rem">Whitelist end in:</h1>
            <Countdown deadline="11/11/2021"></Countdown>
            <hr style="margin: 15px 0" />

            <p class="mb-3">
              Lorem Ipsum is simply dummy text of the printing and typesetting
              my text of the printin
            </p>
            <h1 style="font-size:2.5rem">1.4% Share</h1>
            <p>
              Your point : {{refferalScore}}
            </p>

            <ul class="flex pt-3 m-0 pl-0">
              <li class="mr-3">
        ...
        <div class="col-md-6">
          <div class="feature feature-1 boxed boxed--border">
            <h1 style="font-size:1.5rem" class="mb-0">
              Next generation of game NFTs, cross chain enabled.
            </h1>
            <span>
              Lorem Ipsum is simply dummy text of the printing and
            </span>
            <div class="feature__body mt-10 mb-10">
              <p class="title-ref">Your Referral code</p>

              <div class="input-group">
                <div class="input-group-area">
                  <input :value="currentAddress" type="text" />
                </div>
                <div
...
export default {
  ...
  computed: {
    currentAddress() {
      return "https://ecio.space?ref=123456789";
    }
  },
  methods: {
    onCopy() {
